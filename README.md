...
[![Go Report Card](https://goreportcard.com/badge/github.com/devimteam/zenrpc)](https://goreportcard.com/report/github.com/devimteam/zenrpc) [![Build Status](https://travis-ci.org/semrush/zenrpc.svg?branch=master)](https://travis-ci.org/semrush/zenrpc) [![codecov](https://codecov.io/gh/semrush/zenrpc/branch/master/graph/badge.svg)](https://codecov.io/gh/semrush/zenrpc) [![GoDoc](https://godoc.org/github.com/devimteam/zenrpc?status.svg)](https://godoc.org/github.com/devimteam/zenrpc)
...
```Service is struct with RPC methods, service represents RPC namespace.```
  ...
  1. Install zenrpc generator `go get github.com/devimteam/zenrpc/zenrpc`
  1. Import `github.com/devimteam/zenrpc` into our code with rpc service.
